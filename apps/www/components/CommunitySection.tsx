    ...
    <section id="community" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">Join Our Community</h2>
        ...
        {/* Ways to Contribute */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-black text-center mb-8">Ways to Contribute</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {contributionTypes.map((type, index) => (
              <div key={index} className="bg-white rounded-lg p-6">
                <div className="text-4xl mb-4">{type.icon}</div>
                <h4 className="text-lg font-bold text-black mb-2">{type.title}</h4>
        ...
        <div className="bg-white rounded-lg p-12 text-center border border-gray-200 bg-gray-50">
          ...
          <h3 className="text-2xl font-bold text-black mb-3">Built with Love</h3>
