          ...
          {/* <Combobox value={selectedItem} onChange={setSelectedItem}>
            <div className="relative">
              ...
              <ComboboxInput
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all"
              />
              {filteredSuggestions.length > 0 && (
                <ComboboxOptions className="absolute z-20 mt-1 max-h-60 w-full overflow-auto rounded-lg bg-white py-1 shadow-lg border border-gray-200 focus:outline-none">
